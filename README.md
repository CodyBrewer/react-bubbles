...
- [x] What steps can you take in your web apps to keep your data secure?
      Build protected routes that are only available with a user token that has been verified through proper authentication practices.
- [x] Describe how web servers work.
      Web Severs storeinofrmation and process incoming network requests over http.
